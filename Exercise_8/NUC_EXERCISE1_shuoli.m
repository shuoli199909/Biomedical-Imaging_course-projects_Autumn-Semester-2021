...
function [] = NUC_EXERCISE1()
    ...
    % --------------------------------------------------------------------
    % Set mass attenuation coefficients for 100 keV (CT) and xxx keV (PET)
    % (see: Table 4 in www.nist.gov/pml/data/xraycoef/)
    % --------------------------------------------------------------------
    mac_blood(1)    = 1.695E-01;                % blood  @ 100 keV  [cm2/g]
    mac_blood(2)    = 1.49E-01;                % blood  @ xxx keV  [cm2/g]
    mac_bone(1)     = 1.855E-01;                % bone   @ 100 keV  [cm2/g]
    mac_bone(2)     = 1.86E-01;                % bone   @ xxx keV  [cm2/g]
    mac_lung(1)     = 1.695E-01;                % lung   @ 100 keV  [cm2/g]
    mac_lung(2)     = 1.54E-01;                % lung   @ xxx keV  [cm2/g]
    mac_muscle(1)   = 1.693E-01;                % muscle @ 100 keV  [cm2/g]
    mac_muscle(2)   = 1.69E-01;                % muscle @ xxx keV  [cm2/g]
    mac_water(1)    = 1.707E-01;                % water  @ 100 keV  [cm2/g]
    mac_water(2)    = 1.71E-01;                % water  @ xxx keV  [cm2/g]
    ...
    % Task 1.3.         -30 +25   10  10  0   mue_muscle(2)-mue_lung(2) yyy];   % lung tumor
    ...
    % Task 1.3.                 mue_muscle(1)-mue_lung(1) 0];     % lung tumor
    ...
    % --------------------------------------------------------------------
    % --------------------------------------------------------------------
    % TASK 1.3 Map linear attenuation coefficients from 100 keV to xxx keV
    conversion_factor = (mue_bone(2)-mue_water(2))/(mue_bone(1)-mue_water(1));
    phantom.corr = phantom.ctfbp.*conversion_factor;
    ...
    %phantom.petsino(isnan(phantom.petsino)) = 0;
